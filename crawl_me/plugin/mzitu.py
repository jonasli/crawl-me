...
class MzituHandler(PageBasedHandler):
    ...
    def getPageUrl(self, opener, paraConf):
        ...
        for page in range(paraConf["beginPage"], paraConf["endPage"] + 1):
            crawlUrl = os.path.join(paraConf["url"], "comment-page-"+ str(page))
            urlList.append(crawlUrl)

        for i in range(0,len(urlList)):

            secondLevelUrlList[urlList[i]] = "zipai"
